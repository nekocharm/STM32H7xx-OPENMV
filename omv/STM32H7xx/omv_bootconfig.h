...
#define OMV_BOOT_QSPIF_LAYOUT              {0, 127, 64 * 1024}

// QSPI flash configuration for the bootloader.
#define OMV_BOOT_QSPIF_SIZE_BITS           (23)     // 2**23 == 8MBytes.
...
#define OMV_BOOT_QSPIF_NUM_PAGES           (0x8000) // 32768 pages of 256 bytes

#define OMV_BOOT_QSPIF_SECTOR_SIZE         (0x1000) // 4K bytes sectors.
#define OMV_BOOT_QSPIF_NUM_SECTORS         (0x800) // 2048 sectors of 4K bytes

#define OMV_BOOT_QSPIF_BLOCK_SIZE          (0x10000) // 64K bytes blocks.
#define OMV_BOOT_QSPIF_NUM_BLOCKS          (0x80)  // 128 blocks of 64K bytes

#define OMV_BOOT_QSPIF_CLK_PIN             (GPIO_PIN_2)
#define OMV_BOOT_QSPIF_CLK_PORT            (GPIOB)
#define OMV_BOOT_QSPIF_CLK_ALT             (GPIO_AF9_QUADSPI)

#define OMV_BOOT_QSPIF_CS_PIN              (GPIO_PIN_6)
#define OMV_BOOT_QSPIF_CS_PORT             (GPIOB)
